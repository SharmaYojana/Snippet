...
//import nyc.c4q.yojana.snippet.Notification.AnimalDatabaseHelper;
...
//                    addCat(new Pokemon(catName, lastFed));
//
//                    refreshCatList();
//                } else {
...
//    }
//
//    private void addCat(Pokemon pokemon) {
//        cupboard().withDatabase(db).put(pokemon);
//    }
//
//    private List<Pokemon> selectAllCats() {
//        List<Pokemon> pokemons = new ArrayList<>();
//
//        try {
//            // Iterate cats
//            QueryResultIterable<Pokemon> itr = cupboard().withDatabase(db).query(Pokemon.class).query();
//            for (Pokemon pokemon : itr) {
...
//
//    @Override
//    public void onCatClicked(Pokemon pokemon) {
//        // TODO feed the cat!
//        Toast.makeText(this, "Meow", Toast.LENGTH_SHORT).show();
//    }
//
//    @Override
//    public void onCatLongClicked(Pokemon pokemon) {
//        // TODO delete the cat!
